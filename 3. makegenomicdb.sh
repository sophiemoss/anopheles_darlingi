...
/mnt/storage12/nbillows/Projects/Malaria/fastq2matrix/scripts/merge_vcfs.py genotype --ref genomic.fasta --prefix gambiae_bijagos_2022 > mergevcf_log.txt 2>&1
