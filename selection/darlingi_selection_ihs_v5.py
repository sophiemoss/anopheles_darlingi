...
# %% set wd
os.chdir('/mnt/storage11/sophie/darlingi/darlingi_database/phenotyped_colony/phenotyped_colony_selection')
os.getcwd()
...
# %%
callset = zarr.open('/mnt/storage11/sophie/darlingi/darlingi_database/phenotyped_colony/phenotyped_darlingi_filtered_phased.zarr', mode='r')
