...
# %%
import os
os.chdir('/mnt/storage11/sophie/darlingi/darlingi_database')
os.getcwd()
...
# %%
## import metadata
df_samples=pd.read_csv('/mnt/storage11/sophie/darlingi/darlingi_metadata_admixture_v2.csv',sep=',',usecols=['sample','population','region','country','site'])
df_samples.head()
